...
$(function () {
    ...
    ***************************/
    ...
    // Optimización para galería de fotos: mayor duración y stagger
    const galleryPhotos = document.querySelectorAll('#galeria-fotos .mil-photo-item.mil-up');
    galleryPhotos.forEach((section, i) => {
        section.style.willChange = 'transform, opacity';
        const img = section.querySelector('img');
        if (img) img.loading = 'lazy'; // lazy loading para imágenes
        gsap.fromTo(section, {
            opacity: 0,
            y: 40,
            scale: .98,
            ...
            opacity: 1,
            scale: 1,
            duration: 0.7, // duración aumentada
    ...
    const appearance = document.querySelectorAll('.mil-up:not(#galeria-fotos .mil-photo-item)');
